    ...
    return (
        ...
        <Fragment>
            ...
            <Dialog open={createNew} onClose={handleClose} fullScreen>
                ...
                <DialogContent style={{background: '#fafafa', paddingTop:10}}>
                            ...
                            {items.map((n, index) => {
                                return (
                                    <div className="div-table-row" key={n.id}>
                                        ...
                                        <IconButton onClick={() => handleDeleteConfirm(n.id, 'create')}><DeleteIcon color="secondary" /></IconButton>
                                        </div>
                                    </div>
                                );
                            })}
            ...
            <Dialog open={deleteConfirm} onClose=''>
                ...
                <DialogActions>
                    <Button onClick={() => handleRemove('create')}variant="contained" color="primary" autoFocus>Delete</Button>
